...
fun startRecording(context: Context, videoCapture: VideoCapture<Recorder>, recordingState: MutableState<Recording?>): Recording? {
...
fun stopRecording(context: Context, recordingState: MutableState<Recording?>) {
    try {
